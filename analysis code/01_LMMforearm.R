...
############
# fit model (full)
mod1A<-lme(FL~species*sympatry+sex+AnnualTmin+PETseasonality,random=~1|locality, data = sturnfull)
# evaluate fit
...
mod1A.lm1<-lme(FL~species+sympatry+sex+AnnualTmin+PETseasonality, random=~1|locality, data = sturnfull)
