...
# write to disk
write.csv(headEffectsDF,here("lmmEffects","clustered","CBL.csv"),row.names = FALSE)
# anova
...
# write to disk
write.csv(tidyAovOut,here("lmmEffects","clustered","aovCBL.csv"),row.names = FALSE)
...
# write to disk
write.csv(headlengthLMM,here("lmmEffects","clustered","CBLoutput.csv"),row.names = FALSE)
